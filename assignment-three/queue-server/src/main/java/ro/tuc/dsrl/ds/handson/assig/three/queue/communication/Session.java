 ...
 * @Since: Sep 1, 2015
 * @Description: Serves for dealing with the connection to a client (receiving
 *               messages, decoding them and sending a response).
 */
		...
		try {
			...
			case "READ":
				try {
					...
					// since the underlying queue is a BlockingQueue, this method call will wait if
					// the queue is empty
