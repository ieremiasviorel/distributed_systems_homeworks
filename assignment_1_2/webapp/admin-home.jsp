...
<body>
	...
	<form action="admin" method="post">
		<div class="departure">
			...
			<select name="departure_city" id="departure_city">
				...
				<c:if test="${departureCities != null}">
					<c:forEach items="${departureCities}" var="city">
						<option value="${city.name}" <c:if test="${city.name == flightFilter.departureCity}">selected</c:if>>
							${city.name}
						</option>
					</c:forEach>
				</c:if>
			...
			<input type="date" name="departure_date_start" id="departure_date_start" value="${flightFilter.departureStartDate}">
	...
	<form action="flights" method="post" id="flight-form">
		<input type="text" name="form-flight-id" id="form-flight-id" hidden="true"/>
		<label>Flight Number:</label>
		<input type="text" name="form-flight-number" id="form-flight-number"/>
		<label>Depature:</label>
		<label>Airplane type:</label>
		<input type="text" name="form-airplane-type" id="form-airplane-type"/>
		<br>
		<label>Depature:</label>
		<br>
		<input type="text" name="form-departure-city" id="form-departure-city">
		<input type="date" name="form-departure-date" id="form-departure-date">
		<input type="time" name="form-departure-time" id="form-departure-time">
		<label>Arrival:</label>
		<br>
		<input type="text" name="form-arrival-city" id="form-arrival-city">
		<input type="date" name="form-arrival-date" id="form-arrival-date">
		<input type="time" name="form-arrival-time" id="form-arrival-time">
